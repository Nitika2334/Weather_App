  ...
  return (
    <>
      <div className="flex flex-row justify-center my-6">
        <div className="flex border-spacing-2 flex-row w-3/4 items-center justify-center space-x-4">
          <input
            value={city}
            onChange={(e) => setCity(e.currentTarget.value)}
            type="text"
            placeholder="search by city..."
            className="text-black border-s-black text-xl font-light p-2 w-full shadow-xl capitalize focus:outline-none placeholder:lowercase"
          />
        ...
        <div className="flex text-black flex-row w-1/4 items-center justify-center">
          <button
